...
class Textured_3D_Shader_Program_Light_Grey : public Shader_Program
{
public:
	Textured_3D_Shader_Program_Light_Grey(const Shader* vertex_shader, const Shader* fragment_shader);
	~Textured_3D_Shader_Program_Light_Grey();
