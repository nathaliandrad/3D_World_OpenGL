...
Textured_3D_Shader_Program_Light::Textured_3D_Shader_Program_Light(const Shader* vertex_shader, const Shader* fragment_shader)
	: Shader_Program("Shader_Program.3D.Textured_Light", vertex_shader, fragment_shader)
{
}
Textured_3D_Shader_Program_Light::~Textured_3D_Shader_Program_Light()
{
}

void Textured_3D_Shader_Program_Light::render(const Configuration* config, const Mesh* mesh, const Texture* texture,
