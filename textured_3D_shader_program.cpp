...
Textured_3D_Shader_Program::Textured_3D_Shader_Program(const Shader* vertex_shader, const Shader* fragment_shader)
	: Shader_Program("Shader_Program.3D.Textured", vertex_shader, fragment_shader)
{
}
...
void Textured_3D_Shader_Program::render(const Configuration* config, const Mesh* mesh, const Texture* texture, 
	...
	const glm::mat4 camera, const glm::mat4 projection) const
{
	...
	const glm::vec3 light_position(0.0, 0.0, 1.0);
